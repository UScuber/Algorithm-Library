...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/CGL/GCL_4_B.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_4_B\"\
    ...
    \ U &b){ return a > b ? (a = b, 1) : 0; }\n#line 5 \"test/aoj/CGL/GCL_4_B.test.cpp\"\
    ...
    \n}\n#line 7 \"test/aoj/CGL/GCL_4_B.test.cpp\"\n\nint main(){\n  int n;\n  cin\
    \ >> n;\n  Polygon p(n);\n  rep(i, n) cin >> p[i];\n  printf(\"%.10lf\\n\", convex_diameter(p));\n\
    }\n"
  ...
  verifiedWith: []
documentation_of: test/aoj/CGL/GCL_4_B.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/CGL/GCL_4_B.test.cpp
- /verify/test/aoj/CGL/GCL_4_B.test.cpp.html
