...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/CGL/GCL_7_G.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_7_G\"\
    ...
    \ U &b){ return a > b ? (a = b, 1) : 0; }\n#line 5 \"test/aoj/CGL/GCL_7_G.test.cpp\"\
    ...
    \n}\n#line 7 \"test/aoj/CGL/GCL_7_G.test.cpp\"\n\nint main(){\n  Circle a,b;\n\
    \  cin >> a.p >> a.r >> b.p >> b.r;\n  Points ans;\n  for(const auto &x : tangent(a,\
    \ b)){\n    if(intersect(a, x.a)) ans.push_back(x.a);\n    else ans.push_back(x.b);\n\
    \  }\n  sort(ans.begin(), ans.end());\n  for(const Point &p : ans) printf(\"%.10lf\
    \ %.10lf\\n\", p.real(), p.imag());\n}\n"
  ...
  verifiedWith: []
documentation_of: test/aoj/CGL/GCL_7_G.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/CGL/GCL_7_G.test.cpp
- /verify/test/aoj/CGL/GCL_7_G.test.cpp.html
