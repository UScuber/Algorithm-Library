...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/CGL/GCL_2_D.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_2_D\"\
    ...
    \ = b, 1) : 0; }\n#line 4 \"test/aoj/CGL/GCL_2_D.test.cpp\"\n\n#line 1 \"geometry/template.hpp\"\
    ...
    \n}\n#line 6 \"test/aoj/CGL/GCL_2_D.test.cpp\"\n\nint main(){\n  int q;\n  cin\
    \ >> q;\n  rep(_, q){\n    Segment a,b;\n    cin >> a >> b;\n    printf(\"%.10lf\\\
    n\", distance(a, b));\n  }\n}\n"
  ...
  verifiedWith: []
documentation_of: test/aoj/CGL/GCL_2_D.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/CGL/GCL_2_D.test.cpp
- /verify/test/aoj/CGL/GCL_2_D.test.cpp.html
