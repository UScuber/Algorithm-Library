...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/CGL/GCL_7_H.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_7_H\"\
    ...
    \ = b, 1) : 0; }\n#line 4 \"test/aoj/CGL/GCL_7_H.test.cpp\"\n\n#line 1 \"geometry/template.hpp\"\
    ...
    \n}\n#line 6 \"test/aoj/CGL/GCL_7_H.test.cpp\"\n\nint main(){\n  int n;\n  Circle\
    \ c;\n  cin >> n >> c.r;\n  Polygon p(n);\n  rep(i, n) cin >> p[i];\n  printf(\"\
    %.10lf\\n\", area(p, c));\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_7_H\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/aoj/CGL/GCL_7_H.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/CGL/GCL_7_H.test.cpp
- /verify/test/aoj/CGL/GCL_7_H.test.cpp.html
