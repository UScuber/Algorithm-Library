...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/CGL/GCL_5_A.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_5_A\"\
    ...
    \ = b, 1) : 0; }\n#line 4 \"test/aoj/CGL/GCL_5_A.test.cpp\"\n\n#line 1 \"geometry/template.hpp\"\
    ...
    \n}\n#line 6 \"test/aoj/CGL/GCL_5_A.test.cpp\"\n\nint main(){\n  int n;\n  cin\
    \ >> n;\n  Polygon p(n);\n  rep(i, n) cin >> p[i];\n  printf(\"%.10lf\\n\", closest_pair(p));\n\
    }\n"
  ...
  verifiedWith: []
documentation_of: test/aoj/CGL/GCL_5_A.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/CGL/GCL_5_A.test.cpp
- /verify/test/aoj/CGL/GCL_5_A.test.cpp.html
