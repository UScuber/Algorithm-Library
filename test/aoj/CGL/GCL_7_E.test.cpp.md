...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/CGL/GCL_7_E.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_7_E\"\
    ...
    \ U &b){ return a > b ? (a = b, 1) : 0; }\n#line 5 \"test/aoj/CGL/GCL_7_E.test.cpp\"\
    ...
    \n}\n#line 7 \"test/aoj/CGL/GCL_7_E.test.cpp\"\n\nint main(){\n  Circle a,b;\n\
    \  cin >> a.p >> a.r >> b.p >> b.r;\n  auto ans = crosspoint(a, b);\n  if(ans.first\
    \ > ans.second) swap(ans.first, ans.second);\n  printf(\"%.10lf %.10lf %.10lf\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_7_E\"\n#define\
    ...
    \ ans.second.real(), ans.second.imag());\n}"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/aoj/CGL/GCL_7_E.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/CGL/GCL_7_E.test.cpp
- /verify/test/aoj/CGL/GCL_7_E.test.cpp.html
