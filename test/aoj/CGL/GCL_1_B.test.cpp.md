...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/CGL/GCL_1_B.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/CGL_1_B\"\
    ...
    \ = b, 1) : 0; }\n#line 4 \"test/aoj/CGL/GCL_1_B.test.cpp\"\n\n#line 1 \"geometry/template.hpp\"\
    ...
    \n}\n#line 6 \"test/aoj/CGL/GCL_1_B.test.cpp\"\n\nint main(){\n  cin.tie(nullptr);\n\
    \  ios::sync_with_stdio(false);\n  Line l;\n  cin >> l;\n  int q;\n  cin >> q;\n\
    \  rep(_, q){\n    Point p;\n    cin >> p;\n    const Point res = reflection(l,\
    \ p);\n    printf(\"%.10lf %.10lf\\n\", res.real(), res.imag());\n  }\n}\n"
  ...
  verifiedWith: []
documentation_of: test/aoj/CGL/GCL_1_B.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/CGL/GCL_1_B.test.cpp
- /verify/test/aoj/CGL/GCL_1_B.test.cpp.html
