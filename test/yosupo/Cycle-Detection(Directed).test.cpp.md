...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/Cycle-Detection(Directed).test.cpp\"\n#define\
    ...
    \ = b, 1) : 0; }\n#line 4 \"test/yosupo/Cycle-Detection(Directed).test.cpp\"\n\
    ...
    \       }\r\n        return true;\r\n      }\r\n    }\r\n    used[pos] = 2;\r\n\
    \    return false;\r\n  }\r\n};\n#line 6 \"test/yosupo/Cycle-Detection(Directed).test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/yosupo/Cycle-Detection(Directed).test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/Cycle-Detection(Directed).test.cpp
- /verify/test/yosupo/Cycle-Detection(Directed).test.cpp.html
