...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/Subset-Sum.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/sharp_p_subset_sum\"\
    ...
    \ 4 \"test/yosupo/Subset-Sum.test.cpp\"\n\n#line 1 \"math/convolution/ntt.hpp\"\
    ...
    \ begin(b) + deg };\r\n}\n#line 7 \"test/yosupo/Subset-Sum.test.cpp\"\n\nconstexpr\
    \ int Mod = 998244353;\nusing mint = Mint<Mod>;\nusing fps = FPS<mint>;\n\nint\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/sharp_p_subset_sum\"\n\n\
    ...
    \ ios::sync_with_stdio(false);\n  int n,t;\n  cin >> n >> t;\n  vi cnt(t + 1);\n\
    \  rep(i, n){\n    int s; cin >> s;\n    cnt[s]++;\n  }\n  vector<mint> inv(t\
    \ + 1);\n  inv[1] = 1;\n  for(int i = 2; i <= t; i++) inv[i] = -inv[Mod % i] *\
    \ (Mod / i);\n  FPS<mint> f(t + 1);\n  rep(i, t + 1) if(cnt[i]){\n    int num\
    \ = 1;\n    for(int j = i; j <= t; j += i){\n      if(num & 1) f[j] += inv[num]\
    \ * cnt[i];\n      else f[j] -= inv[num] * cnt[i];\n      num++;\n    }\n  }\n\
  ...
  verifiedWith: []
documentation_of: test/yosupo/Subset-Sum.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/Subset-Sum.test.cpp
- /verify/test/yosupo/Subset-Sum.test.cpp.html
