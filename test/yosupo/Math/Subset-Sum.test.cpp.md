...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo/Math/Subset-Sum.test.cpp\"\n#define PROBLEM\
    ...
    \ begin(b) + deg };\r\n}\n#line 7 \"test/yosupo/Math/Subset-Sum.test.cpp\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/yosupo/Math/Subset-Sum.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo/Math/Subset-Sum.test.cpp
- /verify/test/yosupo/Math/Subset-Sum.test.cpp.html
